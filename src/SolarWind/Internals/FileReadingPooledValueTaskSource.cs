...
namespace PooledValueTaskSource
{
    public class FileReadingPooledValueTaskSource : IValueTaskSource<string>
    {
        ...
        public string GetResult(short token)
        {
            ...
            string result = ResetAndReleaseOperation();
            if (exception != null)
            {
                //TODO: Hmm.. 
                throw exception;
        ...
        public ValueTask<string> RunAsync(string filename, ObjectPool<FileReadingPooledValueTaskSource> pool)
        {
            ...
            // Start async op
            bool isCompleted = FireAsyncWorkWithSyncReturnPossible(filename);
            if (!isCompleted)
            {
        ...
        private void NotifyAsyncWorkCompletion(string data, Exception exception = null)
        {
            ...
            Action<object> previousContinuation = Interlocked.CompareExchange(ref _continuation, CallbackCompleted, null);
            if (previousContinuation != null)
            {
                ...
                if (ec == null)
                {
                    InvokeContinuation(previousContinuation, _state, false);
                }
                else
                {
                    ...
                    ExecutionContext.Run(ec, runState =>
                    {
                        ...
                        t.Item1.InvokeContinuation(t.Item2, t.Item3, false);
        ...
        public void ThrowMultipleContinuations() => throw new InvalidOperationException("Multiple awaiters are not allowed");
